...
export const ARCHETYPES = {
	en: [
		{
			id: "guardian",
			condition: (s: PlayerStats) => s.empathy > 75 && s.courage > 75,
			title: "The Guardian",
		...
		{
			id: "tycoon",
			condition: (s: PlayerStats) => s.ambition > 80 && s.empathy < 40,
			title: "The Tycoon",
		...
		{
			id: "saint",
			condition: (s: PlayerStats) => s.honesty > 80 && s.ambition < 50,
			title: "The Saint",
		...
		{
			id: "maverick",
			condition: (s: PlayerStats) => s.courage > 80 && s.ambition > 70,
			title: "The Maverick",
		...
		{
			id: "healer",
			condition: (s: PlayerStats) => s.empathy > 70 && s.honesty > 70,
			title: "The Healer",
		...
		{
			id: "drifter",
			condition: (s: PlayerStats) => s.empathy < 30 && s.honesty < 30 && s.ambition < 30,
			title: "The Drifter",
		...
		{
			id: "schemer",
			condition: (s: PlayerStats) => s.ambition > 60 && s.honesty < 40,
			title: "The Schemer",
