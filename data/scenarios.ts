...
const SCENARIOS_RU: Scenario[] = [
	// --- ДЕТСТВО ---
	{
		...
		description:
			"Ты бродишь по школьному коридору, гул перемены затихает вдали. В раздевалке пусто, но на скамейке лежит открытый рюкзак твоего лучшего друга. Сверху, будто специально оставленный, блестит тот самый робот-трансформер, о котором ты мечтал месяцами. Хромированные детали ловят луч солнца. Вокруг — ни души.",
		options: [
			{
				text: "Тихо взять робота и спрятать в свой портфель",
				effects: { honesty: -2, ambition: 1 },
				reaction:
					"Холодный металл обжег пальцы. Весь день ты чувствовал этот вес, как горячий камень. Друг искал его в слезах, а ты молчал.",
				summaryFeedback: "Украл и скрыл."
			},
			{
				text: "Подождать друга и честно попросить поиграть",
				effects: { honesty: 1, empathy: 1 },
				reaction:
					"Товарищ расплылся в улыбке: 'Крутой, да? Хочешь, дам погонять на вечер?'. Тепло дружбы оказалось приятнее обладания.",
				summaryFeedback: "Договорился по-честному."
			},
			{
				text: "Проигнорировать и уйти, подавив желание",
				effects: { courage: 1, ambition: -1 },
				reaction:
					"Ты вышел из раздевалки с чистой совестью. Это не твое, и точка. Гордость за свою силу воли успокоила жажду.",
				summaryFeedback: "Победил искушение."
			},
			{
				text: "Спрятать робота под скамейку как шутку",
				effects: { courage: 1, empathy: -1 },
				reaction:
					"Друг в панике перерыл весь рюкзак, пока ты хихикал. Шутка удалась, но его испуганные глаза заставили тебя усомниться в веселье.",
				summaryFeedback: "Жестоко пошутил."
			}
		]
	},
	{
		...
		description:
			"Осенний ливень превратил улицу в серую размытую реку. У подъезда, прижавшись к бетону, сидит крошечный щенок. Он дрожит так сильно, что это видно издалека, и поднимает на тебя мокрые, полные надежды глаза. Шерсть свалялась, он выглядит больным и голодным.",
		options: [
			{
				text: "Схватить щенка и бежать домой",
				effects: { empathy: 2, courage: 1 },
				reaction:
					"Дом наполнился суетой. Когда накормленный малыш уснул у тебя на коленях, ты понял: у тебя появился самый верный друг.",
				summaryFeedback: "Спас новую жизнь."
			},
			{
				text: "Покормить своим завтраком, но не брать",
				effects: { empathy: 1, courage: -1 },
				reaction:
					"Он жадно проглотил еду и лизнул руку. Ты ушел, оглядываясь. На душе скребли кошки, но ты хотя бы дал ему шанс.",
				summaryFeedback: "Подкормил бродягу."
			},
			{
				text: "Пройти мимо, ускорив шаг",
				effects: { empathy: -2, ambition: 1 },
				reaction:
					"Чужие проблемы — не твои. Дома было сухо, но звук дождя напоминал о тихо скулящем комке шерсти.",
				summaryFeedback: "Остался равнодушным."
			},
			{
				text: "Позвать взрослых на помощь",
				effects: { honesty: 1, courage: 1 },
				reaction:
					"Ты не прошел мимо, но и не действовал бездумно. Соседи помогли устроить щенка в тепло. Ты решил проблему по-взрослому.",
				summaryFeedback: "Организовал спасение."
			}
		]
	},
	{
		...
		description:
			"Легендарный дуб на окраине парка. Говорят, с его верхушки виден центр города. Твои приятели стоят внизу и подначивают друг друга: 'Спорим, никто не долезет до вороньего гнезда?'. Веткки на верху выглядят тонкими.",
		options: [
			{
				text: "Принять вызов и лезть на макушку",
				effects: { courage: 2, ambition: 1 },
				reaction:
					"Ветер свистел в ушах, ветка опасно хрустела. Но вот он — горизонт! Ты увидел город как на ладони и стал героем двора.",
				summaryFeedback: "Покорил высоту."
			},
			{
				text: "Залезть до надежной ветки посередине",
				effects: { honesty: 1, ambition: -1 },
				reaction:
					"'Мне и отсюда норм!', — крикнул ты сверху. Тебе не нужно никому ничего доказывать ценой сломанной шеи.",
				summaryFeedback: "Нашел золотую середину."
			},
			{
				text: "Отказаться: 'Это опасно'",
				effects: { courage: -1, honesty: 1 },
				reaction:
					"Над тобой посмеялись, но когда один из смельчаков ободрал ногу, смех стих. Ты остался цел и при своем мнении.",
				summaryFeedback: "Выбрал безопасность."
			},
			{
				text: "Предложить построить шалаш у корней",
				effects: { ambition: 1, empathy: 1 },
				reaction:
					"Ты переключил внимание всех на новую идею. Вскоре вы уже таскали ветки для штаба. Ты стал лидером не силой, а умом.",
				summaryFeedback: "Вдохновил друзей."
			}
		]
	},
	{
